...
{
	die("Access denied!<br/> Log in to access information.");
}
...
<div id="users_msg" style="display:none"></div>

<form id="users_form" method="post" action="users.php">
...
<div id="dialog-form" title="Create new user">
    ...
    <fieldset>
        ...
        <input type="text" name="name" id="uname" class="text ui-widget-content ui-corner-all" />
        <label for="email">Email</label>
        <input type="text" name="email" id="uemail" value="" class="text ui-widget-content ui-corner-all" />
        <label for="password">Password</label>
        <input type="password" name="password" id="upassword" value="" class="text ui-widget-content ui-corner-all" />
    </fieldset>
    </form>
</div>
