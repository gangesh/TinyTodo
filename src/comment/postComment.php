...
echo $q = "INSERT INTO `user_comment` (`id` ,`name` ,`email` ,`comment`, `taskid` ,`date`) VALUES ('' , '$name', '$email', '$comment', `$taskid`, CURRENT_TIMESTAMP);";
echo $result = mysql_query("INSERT INTO `user_comment` (`id` ,`name` ,`email` ,`comment`, `taskid` ,`date`) VALUES ('' , '$name', '$email', '$comment', '', CURRENT_TIMESTAMP);") or die(mysql_error());
