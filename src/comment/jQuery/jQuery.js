...
$(document).ready(function(){
    ...
    $("#saveComment").click(function(){
		...
		var taskid_comment = $("#taskid_comment").val();
        ...
        if(!(isValidEmailAddress(email))){
			...
			$errorDiv.slideUp(2000, function(){$(this).remove();});
		   	return;
				...
				var dataString = 'name=' + name + '&taskid=' + taskid_comment + '&email=' + email + '&comment=' + comment + '&sendCopyToEmail=' + sendCopyToEmail + '&commentProgress=' + commentProgress;
